...
const EmptyOrders = React.forwardRef((props, ref) => {
  return (
    <motion.div 
      ref={ref}
      ...
      exit={{ opacity: 0, y: -10 }}
      className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl shadow-sm border border-gray-100"
    >
      ...
      <h3 className="text-2xl font-bold text-gray-800 tracking-tight">No Orders Yet</h3>
      <p className="text-gray-500 mt-3 text-center max-w-sm font-medium">
